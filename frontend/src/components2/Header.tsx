    ...
    <div className="fixed top-6 left-6 z-50 pointer-events-none select-none">
      ...
      >
        ...
        <div className={`
          ...
          ${isAgent ? 'bg-emerald-100 text-emerald-600' : isListening ? 'bg-indigo-100 text-indigo-600' : 'bg-zinc-100 text-zinc-400'}
        `}>
           {isAgent ? (
        ...
        <div className="flex flex-col">
           <span className={`font-bold text-xs tracking-wider uppercase transition-colors duration-500 ${isAgent ? 'text-emerald-700' : isListening ? 'text-indigo-700' : 'text-zinc-600'}`}>
             INT. AI
           </span>
