...
import { InvoiceDashboardUI } from '../components2_bank/invoice/InvoiceDashboardUI';
...
export default function InvoicePage() {
    ...
    const handleConnect = useCallback(async () => {
        ...
        try {
            ...
            const url = `${TOKEN_ENDPOINT}?name=${userId}&agent=invoice`; // NOTE: Using 'invoice' agent
    ...
    return (
        ...
        >
            <InvoiceDashboardUI onBack={handleBack}>
                ...
                {token ? (
                    ...
                    // DISCONNECTED: Show "Ask Agent" button
